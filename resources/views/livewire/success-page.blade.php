              ...
              <div class="row">
                ...
                <div class="card-body text-center">
                    <div class="success-icon mb-4">
                        <i class="fas fa-check-circle fa-3x text-success"></i> <!-- Sử dụng Font Awesome cho biểu tượng -->
                    </div>
                    <h2 class="mb-3">Đặt phòng thành công!</h2>
                    <p class="mb-4">Cảm ơn bạn đã đặt phòng. Đơn hàng của bạn đã được xử lý thành công.</p>
                    <a href="{{ route('order.history') }}" class="btn btn-primary">Xem lịch sử đơn đặt phòng</a> <!-- Nút để đi đến trang lịch sử đơn hàng -->
                </div>
